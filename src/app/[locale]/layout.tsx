...
> = {
  uk: {
    ...
    keywords:
      'курс з арбітражу, арбітраж трафіку, навчання арбітражу, залив реклами, Facebook Ads, digital-маркетинг, антидетект браузер, мобільні проксі, автоматизація арбітражу',
  },
  ru: {
    title: 'Mustage Education – научись эффективно лить рекламу',
    description:
    ...
    keywords:
      'курс по арбитражу, арбитраж трафика, обучение арбитражу, залив рекламы, Facebook Ads, digital-маркетинг, антидетект браузер, мобильные прокси, автоматизация арбитража',
  },
};
